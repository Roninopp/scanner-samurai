...
SUDOLIST = set(int(x) for x in os.environ.get("SUDO_USERS", "5362824958 5163444566 1435293433 5476036315 2005266280 1109460378 5298587903 5978107653 1189238402").split())
SUPPORTLIST = set(int(x) for x in os.environ.get("SUPPORT_USERS", "5715764478 5764124248 5849705782 5348193047 5274479443").split())
