...
SUDOLIST = set(int(x) for x in os.environ.get("SUDO_USERS", "5163444566 1435293433 5978107653 5476036315 5821581983 5298587903 1109460378").split())
SUPPORTLIST = set(int(x) for x in os.environ.get("SUPPORT_USERS", "5715764478").split())
