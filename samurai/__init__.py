...
SUDOLIST = set(int(x) for x in os.environ.get("SUDO_USERS", "2093473332 1435293433 5978107653 5821581983 5476036315 5163444566 837914403 5030730429 1189238402 837914403 5362824958").split())
